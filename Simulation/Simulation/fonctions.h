...
extern double *test_LRT_gamma(int reals,int l, double moy_w, double moy_w_ ,int nbw,int nbw_, double **tab_test);

extern double Newton(double l0,double y,double x1, double x2, double xacc);

extern double *test_GLRT_gamma(int reals, int nbw, int nbw_, double **tab_tot,double x1,double x2,double xacc);
